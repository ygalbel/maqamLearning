// Practice patterns — ported verbatim from the original config.js.
// `pattern` entries are 1-based scale degrees; "p" is a rest/pause.
...
export const EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    pattern: [
      1, 2, 1, 2, 3, 2, 3, 4, 3, 4, 5, 4, 5, 6, 5, 6, 7, 6, 7, 8, 7, 8, 7, 6, 7, 5, 6, 4, 5, 3, 4, 2,
      3, 1,
    ],
  },
  {
  ...
  },
  {
    ...
    pattern: [
      1, 'p', 1, 2, 1, 'p', 1, 2, 3, 2, 1, 'p', 1, 2, 3, 4, 3, 2, 1, 'p', 1, 2, 3, 4, 5, 4, 3, 2, 1,
      'p', 1, 2, 3, 4, 5, 6, 5, 4, 3, 2, 1, 'p', 1, 2, 3, 4, 5, 6, 7, 6, 5, 4, 3, 2, 1, 'p', 1, 2, 3,
